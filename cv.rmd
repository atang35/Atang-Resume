...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1eh8Yjwp-Uw6k3vkR5IsSS6c2Mk-esiIz7L-0sQ5hNCE/edit?gid=917338460#gid=917338460",  
...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at https://atang35.github.io/Atang-Resume")
} else {
